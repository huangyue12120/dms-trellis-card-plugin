...
| [Quality Guidelines](./quality-guidelines.md) | Code standards, forbidden patterns | v0.3-v0.7.3 data, watcher, UI projection, primary-selection, trusted-root, settings, and State contracts |
